...
1. Create an issue
   ...
   Maintainers will accept your contribution only when it is well aligned with aims and design
   principles of the project. So, it is optional, but recommended for contributors to create an issue
...
1. Create a commit
   ...
   ready to go. Please include `signed-off message` at the end of commit message.

1. Check code format locally

   It is optional, but recommended for contributor to check code format locally before submission.
...
1. Create a PR
   ...
   least two reviewers to be accepted. Please, be sure that **description include at least four words**.
...
1. Update per feedback
   ...
   commit of your pull request later.